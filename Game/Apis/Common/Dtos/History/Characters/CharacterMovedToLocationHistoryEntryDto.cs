...
/// </summary>
public class CharacterMovedToLocationHistoryEntryDto : CharacterHistoryEntryDto
{
    /// <summary>
...
static class CharacterMovedToLocationHistoryEntryMappingExtensions
{
    public static CharacterMovedToLocationHistoryEntryDto ToDto(this EntityMovedToLocationHistoryEntry entry) =>
        new()
        {
            Tick = entry.Tick,
