...
/// </summary>
public class CharacterCombatInPreparationCanceledHistoryEntryDto : CharacterHistoryEntryDto
{
    /// <summary>
...
static class CharacterCombatInPreparationCanceledHistoryEntryMappingExtensions
{
    public static CharacterCombatInPreparationCanceledHistoryEntryDto ToDto(this CharacterCombatInPreparationCanceledHistoryEntry entry) =>
        new()
        {
            Tick = entry.Tick,
